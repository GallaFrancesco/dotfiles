...
(autoload 'sclang-snippets-initialize "sclang-snippets" "\
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "sclang-snippets" '("sclang-snippets-root")))
